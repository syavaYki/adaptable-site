...
Checkout [Live Demo](https://adaptable.podolskiy.dev/)
Project Link: [GitHub](https://github.com/syavaYki/adaptable-site)

## 📸 Screenshot

![Screenshot of the application](/public/assets/adaptable-screenshot.png)
